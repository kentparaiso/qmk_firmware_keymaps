...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_ergodox_pretty(
    KC_ESCAPE,      KC_1,           KC_2,           KC_3,           KC_4,           KC_5,           KC_INSERT,                                      KC_DELETE,      KC_6,           KC_7,           KC_8,           KC_9,           KC_0,           KC_BSPACE,
    KC_TAB,         KC_Q,           KC_W,           KC_E,           KC_R,           KC_T,           DYN_MACRO_PLAY1,                                DYN_MACRO_PLAY2,KC_Y,           KC_U,           KC_I,           KC_O,           KC_P,           KC_MINUS,
    MT(MOD_HYPR, KC_ESCAPE),LGUI_T(KC_A),   LALT_T(KC_S),   LCTL_T(KC_D),   LT(4,KC_F),     KC_G,                                                                           KC_H,           LT(5,KC_J),     RCTL_T(KC_K),   RALT_T(KC_L),   RGUI_T(KC_SCOLON),KC_QUOTE,
    KC_LSHIFT,      KC_Z,           KC_X,           KC_C,           LT(7,KC_V),     KC_B,           KC_LBRACKET,                                    KC_RBRACKET,    KC_N,           LT(6,KC_M),     KC_COMMA,       KC_DOT,         KC_SLASH,       OSM(MOD_RSFT),
    KC_LCTRL,       KC_LGUI,        KC_LALT,        MO(4),          MO(2),                                                                                                          MO(3),          MO(5),          KC_RALT,        KC_RGUI,        KC_RCTRL,
                                                                                                    MO(8),          KC_AUDIO_MUTE,  KC_LEFT,        KC_RIGHT,
                                                                                                                    KC_AUDIO_VOL_UP,KC_UP,
                                                                                    LSFT_T(KC_SPACE),KC_CAPSLOCK,    KC_AUDIO_VOL_DOWN,KC_DOWN,        KC_SCROLLLOCK,  KC_ENTER
  ),
  ...
  [2] = LAYOUT_ergodox_pretty(
    ...
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                                                 KC_LBRACKET,    KC_RBRACKET,    KC_BSLASH,      KC_QUOTE,       KC_TRANSPARENT, KC_TRANSPARENT,
  ...
  [3] = LAYOUT_ergodox_pretty(
    KC_TRANSPARENT, KC_EXLM,        KC_AT,          KC_HASH,        KC_DLR,         KC_PERC,        KC_TRANSPARENT,                                 KC_PSCREEN,     KC_CIRC,        KC_AMPR,        KC_ASTR,        KC_LPRN,        KC_RPRN,        KC_TRANSPARENT,
  ...
  [4] = LAYOUT_ergodox_pretty(
    KC_F1,          KC_F2,          KC_F3,          KC_F4,          KC_F5,          KC_F6,          KC_TRANSPARENT,                                 KC_PSCREEN,     KC_F7,          KC_F8,          KC_F9,          KC_F10,         KC_F11,         KC_F12,
    ...
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_HASH,        KC_HOME,        KC_PGDOWN,      KC_PGUP,        KC_END,         KC_TRANSPARENT,
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                                                                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,
                                                                                                    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,
                                                                                                                    KC_TRANSPARENT, KC_TRANSPARENT,
                                                                                    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT
  ...
  [5] = LAYOUT_ergodox_pretty(
    ...
    KC_TRANSPARENT, KC_AT,          KC_DLR,         KC_AMPR,        KC_BSPACE,      KC_TAB,                                                                         KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,
  ...
  [7] = LAYOUT_ergodox_pretty(
    ...
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_NUMLOCK,     KC_KP_1,        KC_KP_2,        KC_KP_3,        KC_KP_SLASH,    KC_TRANSPARENT,
  ...
  [8] = LAYOUT_ergodox_pretty(
    ...
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, MAGIC_TOGGLE_NKRO,KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                                                                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,
                                                                                                    KC_TRANSPARENT, KC_TRANSPARENT, EEP_RST,        RESET,
                                                                                                                    KC_TRANSPARENT, KC_TRANSPARENT,
                                                                                    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT
  ),
};
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
  switch (keycode) {
    ...
    case ST_MACRO_3:
    if (record->event.pressed) {
      SEND_STRING(SS_RSFT(SS_TAP(X_LBRACKET)) SS_DELAY(100) SS_RSFT(SS_TAP(X_RBRACKET)) SS_DELAY(100) SS_TAP(X_LEFT));
